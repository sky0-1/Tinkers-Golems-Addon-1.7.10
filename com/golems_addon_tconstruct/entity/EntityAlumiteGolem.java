...
public class EntityAlumiteGolem extends GolemBase
{
	public EntityAlumiteGolem(World world) 
	{
		super(world, 8.5F);
	}
	...
	{
		super.entityInit();
		this.setTextureType(this.getGolemTexture(TinkersGolems.MODID, "alumite"));
	}
	...
	public ItemStack getGolemDrops() 
	{
		...
		ArrayList<ItemStack> list = OreDictionary.getOres("ingotAlumite");
		if(!list.isEmpty()) 
		{
